...
describe("FormErrorSummary", () => {
  ...
  it("should call onFieldClick callback when provided", async () => {
    ...
    render(<FormErrorSummary errors={{ amount: "Kwota musi być większa od zera" }} onFieldClick={onFieldClick} />);
  ...
  it("should render Alert component with destructive variant", () => {
    // Arrange & Act
    const { container } = render(<FormErrorSummary errors={{ amount: "Kwota musi być większa od zera" }} />);
  ...
  it("should apply custom className", () => {
    ...
    const { container } = render(
      <FormErrorSummary errors={{ amount: "Kwota musi być większa od zera" }} className="custom-class" />
    );
