...
export function getSupabaseClient() {
  if (import.meta.env.SSR) {
    ...
    throw new Error("supabaseClient should not be used server-side. Use context.locals.supabase instead.");
  }
  ...
  if (!supabaseUrl) {
    throw new Error("PUBLIC_SUPABASE_URL is required. Please set it in your .env file.");
  }

  if (!supabaseAnonKey) {
    throw new Error("PUBLIC_SUPABASE_ANON_KEY is required. Please set it in your .env file.");
  }
